...
with(global.GMLua)
{
	...
	/// @param {Struct.ASTChunk} abstractTree 
	/// @param {Struct.Scope} scope
	/// @param {String} logFolderPath 
	/// @returns {Struct.Scope}
	runAST = function(abstractTree, scope = new Scope(), logFolderPath = undefined )
	{
...
/// @param {Struct.ASTChunk} luaObj 
/// @param {Struct.Scope} scope
/// @param {String} logFolderPath 
/// @returns {Struct.Scope}
function runLua(luaObj, scope = new Scope(), logFolderPath = undefined)
{
