...
with(global.interpreter)
{
	...
	visitChunk = function(chunk, scope = new Scope(noone), addBasicLibrary = true)
	{
	...
	/// @param {Struct.ASTExpression} visitor 
	...
	helpPruneExpList = function (expList,expectedArity = 1)
	{
