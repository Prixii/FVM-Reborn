...
{
	gmlFunctionNameList = [
			"window_mouse_get_x",			"window_mouse_get_y","draw_sprite","draw_self","make_colour_rgb","sprite_add","instance_place_list","collision_point","randomise","irandom","ds_list_create","ds_list_destroy"
	...
	addLibraryFunctions = function(scope,libraryName = "basic")
	{
